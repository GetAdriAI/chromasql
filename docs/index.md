...
- Multi-collection routing primitives and adapters for [sharded deployments](reference/glossary.md/#sharded-deployment).
...
- [:material-robot: **Using ChromaSQL with LLMs**](./using-csql-llm/chromasql-prompt.md)<br/>
