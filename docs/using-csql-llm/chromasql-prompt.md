...
```txt
{{ read_file("using-csql-llm/chromasql-prompt.txt") }}
```

<div class="grid cards" markdown>

- [:material-github: **Have Ideas to Improve the Prompt?**](https://github.com/GetAdriAI/chromasql/issues/new?title=Docs%20Improvement&labels=chromasql-llm){ target="\_blank" }<br/>
